 ...
 * @author keithmiller
 */
public class ox_post {

    private static final Logger logger = Logger.getLogger(ox_post.class.getName());
    private static String myPost;
    ...
    public static void main(String[] args) {
        ...
        myPost = defaultProps.getProperty("myPost");
        ...
        try {
            ...
            Logger.getLogger(ox_post.class.getName()).log(Level.SEVERE, "UTF-8 support needed for OAuth", ex);
            ex.printStackTrace(System.err);
            System.exit(1);
        } catch (IOException ex) {
            Logger.getLogger(ox_post.class.getName()).log(Level.SEVERE, "IO file reading error", ex);
            ex.printStackTrace(System.err);
            System.exit(1);
        } catch (Exception ex) {
            Logger.getLogger(ox_post.class.getName()).log(Level.SEVERE, "API issue", ex);
            ex.printStackTrace(System.err);
            System.exit(1);
        }
        ...
        String json = "";
        try {
            json = cl.getHelper().postAPICall(domain, path, myPost);
        } catch (IOException ex) {
