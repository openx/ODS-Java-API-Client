 ...
 * @author keithmiller
 */
public class ox_check_date_range {
    ...
    public static void main(String[] args) {
        ...
        dateRange = defaultProps.getProperty("dateRange");
        ...
        try {
            json = cl.getHelper().postAPICall(domain, path, dateRange);
        } catch (IOException ex) {
